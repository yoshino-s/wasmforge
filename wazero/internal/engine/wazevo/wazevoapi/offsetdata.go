...
const (
	...
	// ExecutionContextOffsetMemoryFaultTrampolineAddress is an offset of `memoryFaultTrampolineAddress` field in wazevo.executionContext
	ExecutionContextOffsetMemoryFaultTrampolineAddress Offset = 1184
	// ExecutionContextOffsetMemoryFaultAddr is an offset of `memoryFaultAddr` field in wazevo.executionContext
	ExecutionContextOffsetMemoryFaultAddr Offset = 1192
	// ExecutionContextOffsetMemoryFaultSize is an offset of `memoryFaultSize` field in wazevo.executionContext
	ExecutionContextOffsetMemoryFaultSize Offset = 1200
)
